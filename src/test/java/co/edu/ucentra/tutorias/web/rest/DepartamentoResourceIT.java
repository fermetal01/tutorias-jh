...
import co.edu.ucentra.tutorias.repository.DepartamentoRepository;
...
public class DepartamentoResourceIT {
    ...
    private static final String DEFAULT_DECANO = "AAAAAAAAAA";
    private static final String UPDATED_DECANO = "BBBBBBBBBB";
    ...
    public void createDepartamento() throws Exception {
        ...
        assertThat(testDepartamento.getDecano()).isEqualTo(DEFAULT_DECANO);
    }
    ...
    public void getAllDepartamentos() throws Exception {
        ...
        restDepartamentoMockMvc.perform(get("/api/departamentos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].decano").value(hasItem(DEFAULT_DECANO.toString())));
    }
    ...
    public void getDepartamento() throws Exception {
        ...
        restDepartamentoMockMvc.perform(get("/api/departamentos/{id}", departamento.getId()))
            ...
            .andExpect(jsonPath("$.decano").value(DEFAULT_DECANO.toString()));
    }
    ...
    public void updateDepartamento() throws Exception {
        ...
        assertThat(testDepartamento.getDecano()).isEqualTo(UPDATED_DECANO);
    }
