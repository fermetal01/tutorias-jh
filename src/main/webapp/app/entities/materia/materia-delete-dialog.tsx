...
export class MateriaDeleteDialog extends React.Component<IMateriaDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.materiaEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="tutoriasApp.materia.delete.question">
          <Translate contentKey="tutoriasApp.materia.delete.question" interpolate={{ id: materiaEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-materia" color="danger" onClick={this.confirmDelete}>
