...
export class ProfesorUpdate extends React.Component<IProfesorUpdateProps, IProfesorUpdateState> {
  ...
  render() {
    const { profesorEntity, users, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tutoriasApp.profesor.home.createOrEditLabel">
              <Translate contentKey="tutoriasApp.profesor.home.createOrEditLabel">Create or edit a Profesor</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : profesorEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="profesor-user">
                    <Translate contentKey="tutoriasApp.profesor.user">User</Translate>
                  </Label>
                  <AvInput id="profesor-user" type="select" className="form-control" name="user.id">
                    <option value="" key="0" />
                    {users
